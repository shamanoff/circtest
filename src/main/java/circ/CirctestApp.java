...
import circ.config.ApplicationProperties;
import circ.config.DefaultProfileUtil;
...
public class CirctestApp {
    ...
    public CirctestApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes circtest.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(CirctestApp.class);
