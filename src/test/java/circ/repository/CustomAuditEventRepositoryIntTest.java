package circ.repository;

import circ.CirctestApp;
import circ.config.Constants;
import circ.config.audit.AuditEventConverter;
import circ.domain.PersistentAuditEvent;
...
import static circ.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
