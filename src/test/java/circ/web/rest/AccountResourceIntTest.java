package circ.web.rest;

import circ.config.Constants;
import circ.CirctestApp;
import circ.domain.Authority;
import circ.domain.PersistentToken;
import circ.domain.User;
import circ.repository.AuthorityRepository;
import circ.repository.PersistentTokenRepository;
import circ.repository.UserRepository;
import circ.security.AuthoritiesConstants;
import circ.service.MailService;
import circ.service.dto.UserDTO;
import circ.web.rest.errors.ExceptionTranslator;
import circ.web.rest.vm.KeyAndPasswordVM;
import circ.web.rest.vm.ManagedUserVM;
import circ.service.UserService;
...
@SpringBootTest(classes = CirctestApp.class)
