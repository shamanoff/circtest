[![CircleCI](https://circleci.com/gh/shamanoff/circtest.svg?style=svg)](https://circleci.com/gh/shamanoff/circtest)
...
To optimize the circtest application for production, run:
